...
Singleton {
    ...
    function closeAll() { open = false; controlOpen = false; mediaOpen = false; dashOpen = false; wallpaperOpen = false; sidebarOpen = false; diskOpen = false; notifOpen = false; tempOpen = false; sessionOpen = false; trayItem = null }
