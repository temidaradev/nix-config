...
Singleton {
    ...
    function closeAll() { open = false; controlOpen = false; mediaOpen = false; dashOpen = false; wallpaperOpen = false; sidebarOpen = false; diskOpen = false; notifOpen = false; tempOpen = false; settingsOpen = false; trayItem = null }
    ...
    function toggleSettings() { const o = !settingsOpen; closeAll(); settingsOpen = o }
    ...
    IpcHandler { target: "settings"; function toggle(): void { root.toggleSettings() } }
