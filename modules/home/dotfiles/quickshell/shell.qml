...
ShellRoot {
    ...
    Component.onCompleted: { Settings.s; Notifs.count; Wallpaper.current; Devices.all; Battery.present; Brightness.present; Lock.locked; ScreenTime.version }
