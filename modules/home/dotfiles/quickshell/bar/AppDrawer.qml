    ...
    Rectangle {
        ...
        Column {
            ...
            Rectangle {   // search box
                ...
                Row {
                    ...
                    TextInput {
                        ...
                        Text {
                            visible: search.text === ""
                            text: "Search applications…"; color: Theme.fgDim
                            font.family: Theme.font; font.pointSize: Theme.fontSize
                        }
                        ...
                        Keys.onReturnPressed: win.launch(win.apps[win.current])
                        Keys.onEnterPressed: win.launch(win.apps[win.current])
            ...
            Row {   // session controls
                ...
                SessionButton { glyph: "⏻"; onClicked: win.run(["systemctl", "poweroff"]) }
                ...
                SessionButton { glyph: "󰌾"; onClicked: win.run(["swaylock", "-f", "-c", "1b1e20"]) }
